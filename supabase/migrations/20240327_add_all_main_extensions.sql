-- Suppression des anciennes extensions pour éviter les doublons
DELETE FROM extensions WHERE series_id IN (
    SELECT id FROM series WHERE code IN ('XY', 'NB', 'CL', 'HGSS', 'PL', 'DP', 'EX', 'WIZ')
);
